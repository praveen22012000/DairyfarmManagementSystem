...
<body>
    ...
    <div class="payment-details">
        <p><strong>Supplier Name:</strong> {{ $payment->purchase_vaccine->supplier->name }}</p>
        <p><strong>Purchase ID:</strong> {{ $payment->purchase_vaccine->id }}</p>
    ...
    <table>
        ...
        <tbody>
            @foreach($payment->purchase_vaccine->purchase_vaccine_items as $item)
            <tr>
