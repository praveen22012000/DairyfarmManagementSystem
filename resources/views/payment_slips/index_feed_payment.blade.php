...
<body>
    ...
    <div class="payment-details">
        <p><strong>Supplier Name:</strong> {{ $payment->purchase_feed->supplier->name }}</p>
        <p><strong>Purchase ID:</strong> {{ $payment->purchase_feed->id }}</p>
        <p><strong>Amount Paid:</strong> {{ $payment->payment_amount }}</p>
        <p><strong>Paid By:</strong> {{ $payment->user->name }}</p>
    </div>
     ...
     <table>
        ...
        <tbody>
            @foreach($payment->purchase_feed->purchase_feed_items as $item)
            <tr>
                <td>{{ $item->feed_id }}</td>
                <td>{{ $item->feed->feed_name }}</td>
