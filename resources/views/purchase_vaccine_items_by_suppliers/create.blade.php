...
<div class="col-md-12">
    ...
    <form action="{{route('purchase_vaccine_items.store')}}" method="POST" class="space-y-8">
        @csrf
        ...
        <div class="overflow-x-auto">
            <table  class="table" id="purchaseTable">
                ...
                @php
                        ...
                        $rowCount = max(count($oldVaccineIds), 1);
                @endphp
                ...
                <tr class="purchase-row">
                        ...
                        <td class="border-t px-6 py-4 text-left text-gray-800">
                                <select name="vaccine_id[]" id="vaccine_id" class="border border-gray-400 rounded-lg px-4 py-2 w-full focus:ring-2 focus:ring-blue-500 focus:outline-none">
                                    ...
                                    {{ (isset($oldVaccineIds[$i]) && $oldVaccineIds[$i] == $vaccine->id) ? 'selected' : '' }}
...
$(document).ready(function () {
    ...
    function updateAddButtonVisibility() {
        let totalFeedItems = $("#purchaseTable tbody tr:first").find("select[name='vaccine_id[]'] option").length - 1; // Exclude the default option
    ...
    function updateFeedItemOptions() {
        ...
        $("select[name='vaccine_id[]']").each(function () {//Loops through each <select> element with the name feed_id[].
        ...
        $("select[name='vaccine_id[]']").each(function () {//Loops through each dropdown (<select>) again.
    ...
    $(document).on("change", "select[name='vaccine_id[]']", function () {//Listens for changes in any <select> element with name='feed_id[]' (i.e., feed item dropdowns).
