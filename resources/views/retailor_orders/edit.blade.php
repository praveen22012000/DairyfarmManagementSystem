...
<div class="col-md-12">
    ...
    <form action="{{ route('retailor_order_items.update',$retailororder->id) }}" method="POST" class="space-y-8">
        @csrf
        ...
        <br>
            <div>
                ...
                <input type="text" name="delivery_address" id="delivery_address" placeholder="Enter your delivery address" class="form-control rounded" value="{{ $retailororder->delivery_address}}" >
        ...
        <div class="overflow-x-auto">
            <table id="milkTable" class="table">
                ...
                <tbody>
                    ...
                    @error("product_id.$index") <span class="text-danger">{{ $message }}</span> @enderror
                    </td>
                      
                        <td class="border-t px-6 py-4">
                            <input type="number" name="ordered_quantity[]" class="form-control rounded" value="{{ old('ordered_quantity.' . $loop->index, $item->ordered_quantity) }}">
