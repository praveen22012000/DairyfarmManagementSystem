...
<div class="container">
    ...
    <form method="POST" action="{{ route('sales_manager.update',$salesmanager->id) }}">
        @csrf
        <!-- Role Selection -->
        ...
        <div class="form-group">
            ...
            <select id="role_id" name="role_id" disabled class="form-control">
                ...
                <option value="{{ $role->id }}" {{ $salesmanager->user->role_id == $role->id ? 'selected' : '' }}>
                    {{ $role->role_name }}
                </option>
                @endforeach
            </select>
       ...
       <div id="sales_manager_fields" class="d-none" >
            ...
            <div class="form-group">
                        <label for="sales_manager_id">General Manager</label><br>
                            <select name="sales_manager_id" id="sales_manager_id"  class="form-control">
                                ...
                                @foreach($sales_managers as $sales_man)
                                <option value="{{ $sales_man->sales_manager_id }}"
                                {{ $salesmanager->sales_manager_id == $sales_man->sales_manager_id ? 'selected' : ''}}
                                >{{ $salesmanager->user->name }}</option>
                                @endforeach
            ...
            <div class="form-group">
                ...
                <input type="date" value="{{ $salesmanager->sales_manager_hire_date }}" name="sales_manager_hire_date" class="form-control rounded" id="sales_manager_hire_date" >
            ...
            <div class="form-group">
                ...
                <input type="text" value="{{ $salesmanager->sales_manager_qualification }}" name="sales_manager_qualification" class="form-control rounded" id="sales_manager_qualification" >
