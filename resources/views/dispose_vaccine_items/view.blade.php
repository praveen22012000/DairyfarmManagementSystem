...
@endif
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
                ...
                <input type="date" name="dispose_date" id="date" class="form-control rounded" value="{{$disposevaccineitem->dispose_vaccine_details->dispose_date}}" >
            ...
            <div>
                ...
                <input type="time" name="dispose_time" id="time" class="form-control rounded" value="{{$disposevaccineitem->dispose_vaccine_details->dispose_time}}" >
        ...
        <div class="overflow-x-auto">
            <table id="disposeFeedTable" class="table">
                <thead class="thead-dark">
                    <tr>
                        <th class="border-b px-6 py-4 text-left">Vaccine Item</th>
                        ...
                        <td class="border-t px-6 py-4 text-left text-gray-800">
                            ...
                            <option value="">Select the Vaccine Item</option>
                                @foreach($purchaseVaccineItems as $purchaseVaccineItem)
                                  ...
                                  {{$disposevaccineitem->purchase_vaccine_item_id==$purchaseVaccineItem->id ? 'selected' : '' }}
                            ...
                            @error("purchase_vaccine_item_id") <span class="text-danger">{{ $message }}</span> @enderror
                        </td>
        ...
        <a href="{{ route('purchase_vaccine_items.list') }}" class="btn btn-info">Back</a>
