...
<div class="col-md-12">
    ...
    <form  method="POST" enctype="multipart/form-data" action="{{route('animal_pregnancies.update',$pregnancie->id)}}">
        @csrf
...
@endif
    ...
    <!--this is used to list the female_cow_name -->
        ...
        <select name="female_cow_id" id="female_cow_id" class="form-control">
            ...
            @foreach($female_Animals as $female_Animal)
               ...
               {{ $pregnancie->female_cow_id == $female_Animal->id ? 'selected':'' }}
    ...
    <!--this is used to list the Breeding Event -->
        ...
        <select name="breeding_id" id="breeding_id" class="form-control">
               ...
               {{ $pregnancie->breeding_id == $breeding->id ? 'selected':''}}
                >
        ...
        <select name="veterinarian_id" id="veterinarian_id" class="form-control">
                ...
                {{ $pregnancie->veterinarian_id == $veterinarian->id ? 'selected':'' }}
        ...
        <div class="form-group">
            <label for="estimated_calving_date">Estimated_calving_date</label>
                <input type="date" name="estimated_calving_date" class="form-control rounded" id="estimated_calving_date" value="{{$pregnancie->estimated_calving_date}}">
        ...
        <div class="form-group">
            <label for="confirmation_date">Confirmation_date</label>
                <input type="date" name="confirmation_date" class="form-control rounded" id="confirmation_date" value="{{$pregnancie->confirmation_date}}">
