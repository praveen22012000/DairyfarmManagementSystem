...
<html>
<head>
    <title>Delivered Retailor Order Products</title>
    <style>
...
<body>
    ...
    <div class="report-title">Delivered Retailor Order Products</div>
        ...
        <tbody>
            @foreach($totalDeliveredOrders as $item)
                <tr>
                    ...
                    <td>{{ number_format($item->total_delivered_quantity, 2) }}</td>
                </tr>
            @endforeach
        </tbody>
    </table>
