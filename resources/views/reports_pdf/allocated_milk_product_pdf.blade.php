...
<body>
    ...
    <div class="report-title">Milk Production Report</div>
    ...
    <thead>
        <tr>
            <th>Product Name</th>
            <th>Total Allocated Quantity (Liters)</th>
        </tr>
    </thead>
    <tbody>
        @foreach($allocatedMilk as $milk)
            <tr>
                <td>{{ $milk->product_name }}</td>
                <td>{{ number_format($milk->total_allocated_quantity, 2) }}</td>
            </tr>
        @endforeach
    </tbody>
</table>
