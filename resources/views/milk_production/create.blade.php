...
@endif
        ...
        <select name="animal_id" id="animal_id" class="form-control" >
                ...
                {{ old('animal_id') == $female_Animal->id ? 'selected': '' }}
        ...
        <div class="form-group">
            <label for="production_date">Milk Production Date</label>
                <input type="date" name="production_date" class="form-control rounded" value="{{ old('production_date') }}" id="production_date">
        ...
        <div class="form-group">
            ...
            <input type="text" name="Quantity_Liters" class="form-control rounded" value="{{ old('Quantity_Liters') }}" id="Quantity_Liters" >
        ...
        <select name="user_id" id="user_id" class="form-control" >
                ...
                <option value="{{ $farm_labor->id }}" {{ old('user_id') == $farm_labor->id ? 'selected' : '' }}
        ...
        <div class="form-group">
                ...
                <input type="radio" id="morning" name="shift"  value="Morning" {{ old('shift') == 'Morning' ? 'checked' : '' }}>
                <label for="male">Morning</label><br>

                <input type="radio" id="afternoon" name="shift" value="Afternoon" {{ old('shift') == 'Afternoon' ? 'checked' : '' }}>
                <label for="female">Afternoon</label><br>

                <input type="radio" id="evening" name="shift" value="Evening"  {{ old('shift') == 'Evening' ? 'checked' : '' }}>
        ...
        <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control rounded" id="fat_percentage" name="fat_percentage" value="{{ old('fat_percentage') }}" placeholder="Enter Fat Percentage">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control rounded" id="protein_percentage" name="protein_percentage" value="{{ old('protein_percentage') }}" placeholder="Enter Protein Percentage">
        ...
        <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control rounded" id="somatic_cell_count" name="somatic_cell_count" value="{{ old('somatic_cell_count') }}" placeholder="Enter somatic cell count">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control rounded" id="lactose_percentage" name="lactose_percentage" value="{{ old('lactose_percentage') }}" placeholder="Enter the lactose Percentage">
