...
@endif
            ...
            <table id="disposeFeedTable" class="table">
                ...
                <tbody>
                    @php
                        ...
                        $rowCount = max(count($oldPurchaseFeedItemIds), 1);
                    @endphp
                    ...
                    <tr  class="milk-row">
                        <td class="border-t px-6 py-4 text-left text-gray-800">
                            ...
                            <option value="">Select the FeedItem</option>
                                @foreach($purchaseFeedItems as $purchaseFeedItem)
                                    ...
                                    {{ (isset($oldPurchaseFeedItemIds[$i]) && $oldPurchaseFeedItemIds[$i] == $purchaseFeedItem->id) ? 'selected' : '' }}
                        ...
                        <td class="border-t px-6 py-4 text-left text-gray-800">
                            <input type="number" class="form-control" name="quantity[]" value="{{ isset($oldPurchaseFeedItemIds[$i]) ? ($purchaseFeedItems->firstWhere('id', $oldPurchaseFeedItemIds[$i])?->stock_quantity ?? '') : '' }}" style="width: 80px;" readonly>
                        </td>
        ...
        <div class="flex justify-center">
            <button type="submit" class="btn btn-success mt-3">Save  Dispose Record</button>
        </div>
    </form>
</div>
